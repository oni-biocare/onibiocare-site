...
import DoseProductSuggestions from "./DoseProductSuggestions";
...
export default function CuteDoseResultsPage({ allProducts }: Props) {
    ...
    useEffect(() => {
        ...
        // Compute suggested products to include in Telegram notification
        const suggested = getSuggestedProducts(results.insights.priority, allProducts);
        const suggestedProductNames = suggested.map((p) => p.title);
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 mx-auto max-w-md px-5 pb-16 pt-8">
                ...
                {/* ── Product Suggestions ─────────────────────────────── */}
                <DoseProductSuggestions
                    priority={results.insights.priority}
